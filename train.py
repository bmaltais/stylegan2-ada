...
def setup_training_options(
    ...
    cfg_specs = {
        ...
        '16gb-gpu-256':     dict(ref_gpus=1,  kimg=25000,  mb=16, mbstd=8,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=8), # uses mixed-precision, 11GB GPU and some auto
        '16gb-gpu-256v2':   dict(ref_gpus=1,  kimg=25000,  mb=28, mbstd=8,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=8), # uses mixed-precision, 11GB GPU and some auto
        '16gb-gpu-512':     dict(ref_gpus=1,  kimg=25000,  mb=16, mbstd=4,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=8), # uses mixed-precision, 11GB GPU and some auto
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['auto', '11gb-gpu', '11gb-gpu-complex', '16gb-gpu-256', '16gb-gpu-256v2', '16gb-gpu-512', '24gb-gpu','24gb-gpu-complex', '48gb-gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
